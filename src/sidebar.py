...
class SideBar(object):
    ...
    def setup_sidebar(self):
        ...
        self.buildicons_textures = {}
        self.buildicons_textures['base'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "base_iso.png"))
        self.buildicons_textures['garden'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "foodpod_iso.png"))
        self.buildicons_textures['solar'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "solargen_iso.png"))
        self.buildicons_textures['geo'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "geotherm001_iso.png"))
        self.buildicons_textures['battery'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "battery_iso.png"))
        self.buildicons_textures['iceextract'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "generator_iso.png"))
        self.buildicons_textures['co2extract'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "generator_iso.png"))
        self.buildicons_textures['fe_mining'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "mininggear_iso.png"))
        self.buildicons_textures['factory_co2'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "factory_co2_iso.png"))
        self.buildicons_textures['factory_h2o'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "factory_h2o_iso.png"))
        self.buildicons_textures['factory_poly'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "factory_poly_iso.png"))
        self.buildicons_textures['tank'] = arcade.load_texture(str(ASSET_PATH / "sprites_iso" / "tank_iso.png"))
    ...
    def CheckforBuild(self, coords):
        if coords is None or self.trybuild == None:
            self.trybuild = None
            self.msg_to = 0
            return
        ...
        tile_x = int(x/80)
        tile_y = int(y/80)
        print ('building at:',tile_x,tile_y)
